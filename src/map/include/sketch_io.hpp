...
namespace skch
{
inline void saveReferenceSketch(const Sketch &sketch, const Parameters &parameters,
                                const std::string &outFile)
{
  ...
  std::vector<MinimizerMapKeyType> sortedKeys;
  sortedKeys.reserve(nKeys);
  ...
  {
    const MinimizerMapValueType &vals = sketch.minimizerPosLookupIndex.at(key);
...
inline Sketch loadReferenceSketch(const Parameters &parameters, const std::string &inFile)
{
